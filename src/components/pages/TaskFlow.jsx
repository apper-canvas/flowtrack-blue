...
const TaskFlow = () => {
  ...
  const triggerConfetti = () => {
    // Optional: implement confetti animation
...
setCreatingTask(true)
    ...
    try {
      ...
      // Note: File handling would require fileService import
      // if (taskData.files && taskData.files.length > 0) {
      //   try {
      //     await fileService.createFiles(newTask.Id, taskData.files);
      //   } catch (fileError) {
      //     console.error("Error creating files:", fileError);
      //     toast.warning("Task created but some files failed to upload");
      //   }
      // }
